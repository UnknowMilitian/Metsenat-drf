    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money', models.IntegerField(default=1000000, verbose_name='Maney')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('type_user', models.CharField(choices=[('Sponsor', 'sponsor'), ('Student', 'student')], default='Student', max_length=8)),
                ('fullname', models.CharField(max_length=255, verbose_name='Fullname')),
                ('telephone', models.CharField(max_length=255, unique=True, verbose_name='Telephone')),
                ...
                ('payment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_payment', to='main.payment', verbose_name='Payment')),
